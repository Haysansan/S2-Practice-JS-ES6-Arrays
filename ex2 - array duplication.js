...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Nguyen", age: 20 },
  { firstName: "Bình",lastName: "Tran" , age: 22 },
  { firstName: "Cẩm", lastName: "Le", age: 21 },
  { firstName: "An", lastName: "Nguyen", age: 19 }, // Duplicate first name !
];

/**
 * Update 1 student age, given his/her first name
 * @param {string} firstName - the student first name
 * @param {string} lastName  - the student new age
 * @param {string} batch  - the student new age
